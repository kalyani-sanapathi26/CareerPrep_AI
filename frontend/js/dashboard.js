...
function renderCompanyDetail(companyName) {
    ...
    const pdfLink = company.pdf ? '<a class="pdf-link" href="' + company.pdf + '" download>Download previous-year pattern PDF</a>' : '<p class="pdf-note">PDF resource is coming soon for this company.</p>';
